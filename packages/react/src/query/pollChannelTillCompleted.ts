...
export type PollChannelTillCompletedOptions =
  UnionPartial<PollChannelTillCompletedParameters> & ScopeKeyParameter
...
> {
  return {
    ...
    async queryFn({ queryKey }) {
      ...
      return pollChannelTillCompleted(config, {
        channelToken,
        timeout,
        interval,
      })
...
export type PollChannelTillCompletedQueryFnData =
  PollChannelTillCompletedReturnType

export type PollChannelTillCompletedData = PollChannelTillCompletedQueryFnData

export function pollChannelTillCompletedQueryKey(
  options: PollChannelTillCompletedOptions = {},
) {
  return ['pollChannelTillCompleted', filterQueryOptions(options)] as const
}

export type PollChannelTillCompletedQueryKey = ReturnType<
  typeof pollChannelTillCompletedQueryKey
>

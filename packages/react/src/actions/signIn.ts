import type {
  AuthClientError,
  PollChannelTillCompletedParameters,
...
export type SignInParameters = Omit<
  PollChannelTillCompletedParameters,
  'channelToken'
> & {
  channelToken: string
...
export type SignInReturnType = PollChannelTillCompletedReturnType & {
...
export async function signIn(
  ...
  const pollChannelTillCompletedResponse =
    await config.appClient.pollChannelTillCompleted({

import type {
  AuthClientError,
  PollChannelTillCompletedParameters as client_PollChannelTilCompletedParameters,
  PollChannelTillCompletedReturnType as client_PollChannelTilCompletedReturnType,
} from '@fc-auth/core'
import type { Config } from '../types/config.js'

export type PollChannelTillCompletedParameters =
  client_PollChannelTilCompletedParameters

export type PollChannelTillCompletedReturnType =
  client_PollChannelTilCompletedReturnType
